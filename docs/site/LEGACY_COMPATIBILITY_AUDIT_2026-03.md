...
| `/lab/simulators/*` | simulators legacy secondary hub | `ENTITY_REGISTRY_DAVYDOVMY.md`, `lab/_manifest.json`, `simulators/ad-auction/docs/README.md`, docs/site/* | 5 | medium | трактовать как legacy secondary; не продвигать как canonical |
