...
как inline-ссылки на глоссарий с классом `term-link`.
...
---
### Decision block (канонический компонент)

Decision-блок — это финальный смысловой элемент страницы.
...
и идёт именно в этом порядке:

1. **Решение**  
   Короткий заголовок блока.  
   Не содержит выводов — только обозначает, что ниже именно решение.
